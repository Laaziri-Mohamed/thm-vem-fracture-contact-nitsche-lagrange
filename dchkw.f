...
C
      ...
      IF( LOCIW.GT.LENIW ) THEN
         ...
         write(*,*)' Iwork too short '
c         CALL XERMSG ('SLATEC', 'DCHKW',
c     $      'In ' // XERNAM // ', INTEGER work array too short.  ' //
c     $      'IWORK needs ' // XERN1 // '; have allocated ' // XERN2,
c     $      1, 1)
      ENDIF
C
C         Check the Double Precision workspace situation.
      IF( LOCW.GT.LENW ) THEN
         ...
         WRITE (XERN1, '(I8)') LOCW
         WRITE (XERN2, '(I8)') LENW
         write(*,*)' Rwork too short '
c         CALL XERMSG ('SLATEC', 'DCHKW',
c     $      'In ' // XERNAM // ', DOUBLE PRECISION work array too ' //
c     $      'short.  RWORK needs ' // XERN1 // '; have allocated ' //
c     $      XERN2, 1, 1)
      ENDIF
      RETURN
