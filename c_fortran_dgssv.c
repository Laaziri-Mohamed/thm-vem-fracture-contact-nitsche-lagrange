...
c_fortran_dgssv_(int *iopt, int *n, int *nnz, int *nrhs, 
                 ...
                 double *b, int *ldb, 
                 double *cpu_fact_used, double *cpu_solve_used,
...
/* 		   mem_usage.for_lu/1e6, mem_usage.total_needed/1e6); */
       ...
       *cpu_fact_used = ((double) (end - start)) / CLOCKS_PER_SEC;

       /*        printf(" CPU time factorization  %f\n",*cpu_fact_used); 
...
/* 	perm_r = LUfactors->perm_r; */
	...
	dCreate_Dense_Matrix(&B, *n, *nrhs, b, *ldb, SLU_DN, SLU_D, SLU_GE);
       ...
       *cpu_solve_used = ((double) (end - start)) / CLOCKS_PER_SEC;
/*        printf(" CPU time solve  %f\n",*cpu_solve_used); */
